...
namespace webApi.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new MyUser { UserName = Input.Email, Email = Input.Email, other_email = Input.other_email,
                PhoneNumber = Input.phone, address = Input.address, address2 = Input.address2, affiliation = Input.affiliation,
                 postcode = Input.postcode, region = Input.region, city = Input.city, country = Input.country };
